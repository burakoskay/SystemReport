...
modified_date: 2026-04-22T13:54:08.334Z
...
In a move that has sparked debate across the sector, Netgear received "conditional approval" from the FCC, granting it an exemption that allows its Nighthawk and Orbi mesh router lines to continue receiving software updates and enabling the company to release new models until October 1, 2027. Netgear CEO CJ Prober lauded the decision, positioning the US-headquartered company as a "trusted consumer router company" committed to a "more secure digital future."

However, this conditional approval carries significant implications, effectively granting Netgear a de facto, albeit potentially temporary, monopoly in the US consumer router market. The vast majority of router companies, including many headquartered in the US, rely on overseas manufacturing, primarily in Asia. Competitors like Amazon's Eero and Google's Nest WiFi Pro, whose devices are also largely foreign-made, currently lack similar exemptions. The FCC's silence on what makes Netgear's foreign-manufactured routers inherently "safer" than its competitors remains a glaring omission.
