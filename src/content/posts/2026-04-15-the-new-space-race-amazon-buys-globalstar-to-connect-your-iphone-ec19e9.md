...
modified_date: 2026-09-25T02:58:33.246Z
...
- **2026-09-25** — Apple shares video highlighting new child safety features across its devices ([source](https://9to5mac.com/2026/09/24/apple-shares-video-highlighting-new-child-safety-features-across-its-devices/))
- **2026-08-21** — Google Home update lets you set light color temperature to your favorite kelvin using voice commands ([source](https://9to5google.com/2026/08/20/google-home-update-improves-voice-controls/))
- **2026-08-21** — Aaron Swartz was prosecuted for scraping, while Meta does it without consequence ([source](https://blog.curiousquail.com/im-upset-again-about-a-co-creator-of-rss-being-prosecuted-for-something-meta-is-doing-with-little-consequence/))
- **2026-08-13** — The Best Spotify Alternatives to Ease Your Conscience ([source](https://www.engadget.com/2234678/best-spotify-alternatives-2026/))
...
- **2026-05-06** — Amazon Blink beats Google’s 2K Nest Doorbell with the same quality for under $50 ([source](https://9to5google.com/2026/05/06/amazon-blink-2k-doorbell/))
